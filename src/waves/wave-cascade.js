...
export const wave_cascade = (() => {
    ...
    class WaveCascade extends entity.Component {
        ...
        Update(_){
            ...
            this.computeTimeSpectrum.computeNode.parameters.time.value += 0.035;//this.params_.clock.elapsedTime;
            ...
            this.computeMergeTextures.computeNode.parameters.deltaTime.value = 1000 * Math.exp(-1 * this.params_.clock.elapsedTime) + 0.035;
            ...
            //for better quality
            //need mipmaps, linearMipmapLinearFilter, maxAnisotropy, 
            //need FXAA postprocessing in wave-generator or main
